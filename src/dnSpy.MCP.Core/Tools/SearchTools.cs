...
namespace dnSpy.MCP.Core.Tools {
    public sealed class SearchTools {
        ...
        public string SearchMethods(string pattern, string? typeFullName = null, string? assembly = null) {
            ...
            var methods = _ctx.Resolver.SearchMethods(pattern, typeFullName, assembly).ToList();
        ...
        public string SearchStrings(string? pattern = null, int minLength = 4, string? assembly = null) {
            if (_ctx.AssemblyLoader.GetDocuments().Count == 0)
                return "Error: No assemblies loaded.";
        ...
        private List<string> CollectStringLiterals(string? pattern, int minLength, string? assembly = null) {
